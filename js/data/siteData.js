...
const siteData = {
  ...
  navigation: [
    ...
    { label: "Speaking",       href: "pages/speaking.html" },
  ...
  sections: [
    ...
    },
    {
      ...
      description: "Invited speaker at international academic conferences including the 2026 International Conference on Smart Futuristic Technology and the 2026 International Conference on Computing Theory and Wireless Communications.",
      link: "pages/speaking.html",
      linkText: "View speaking engagements",
    },
    {
      icon: "⚡",
      title: "Expertise",
  ...
  publications: {
    ...
    papers: [
      ...
      },
      {
        ...
        venue: "2025 International Conference on Metaverse and Current Trends in Computing (ICMCTC)",
        year: 2025,
        citations: 7,
        role: "Co-Author",
        tags: ["LLM", "AI/ML", "NLP"],
      ...
      {
        title: "A Framework for Intelligent Cloud Systems: Enabling Secure, Policy-Driven, and Sustainable AI at Scale",
      ...
      {
        title: "Enhancing Smart City Infrastructures With AI, Data Analytics, and Digital Marketing Technologies",
        authors: "SB Peta (Primary Author)",
        venue: "2025 ICBATS",
        year: 2025,
        citations: 1,
        role: "Primary Author",
        tags: ["Smart Cities", "AI", "Digital Marketing"],
      },
      {
        ...
        citations: 1,
        role: "Co-Author",
        tags: ["AI", "HPC", "Compilers"],
      },
      {
        title: "Privacy-Preserving Generative AI (GAI): Exploring GAI Model Variants to Create Synthetic Data Without Compromising Privacy",
        authors: "SB Peta et al.",
        venue: "2025 AIST",
        year: 2025,
        citations: 0,
        role: "Co-Author",
        tags: ["Generative AI", "Privacy", "Synthetic Data"],
      },
    ],
    journals: [
      { title: "International Journal of Communication Networks and Information Security (IJCNIS)", role: "Primary Author" },
      { title: "TechRxiv / Authorea", role: "Co-Author" },
      { title: "Sch J App Med Sci (SAS Publishers)", role: "Co-Author" },
      { title: "Sch J Eng Tech (SAS Publishers)", role: "Co-Author" },
    ],
    recognition: [
  ...
  /* ────────────────────────────────────────────────────────────────────────
     SPEAKER ENGAGEMENTS (from EB1A PDF)
     ──────────────────────────────────────────────────────────────────────── */
  speaker: [
    {
      event: "International Conference on Smart Futuristic Technology",
      year: 2026,
      icon: "🎤",
    },
    {
      event: "International Conference on Computing Theory and Wireless Communications",
      year: 2026,
      icon: "🎤",
    },
  ],
